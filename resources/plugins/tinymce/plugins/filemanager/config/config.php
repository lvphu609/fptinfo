...
$upload_dir = '/fptinfo_project/resources/uploads/source/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../../../resources/uploads/source/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../../../../../resources/uploads/thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
